...
public class ContatoDAOH implements IContatoRepositorio {
    ...
    public List<Contato> obterTodosPorUsuario(int usuarioId, Integer limit, Integer offset) throws SQLException {
        return em.createQuery(
                String.format("FROM Contato WHERE fkUsuario = %d", usuarioId)
        ).getResultList();
    }
     ...
     */
    @Override
    public Contato adicionar(Contato entidade) throws SQLException {
        return null;
    }
     ...
     */
    @Override
    public void atualizar(Contato entidade) throws SQLException {
     ...
     */
    @Override
    public Contato obterPorId(int id) throws SQLException {
        return null;
    }
